...
function useDiffViewState(t0) {
  ...
  const mode = t2, anyParamSet = [previousDocument, nextDocument, mode].some(_temp$M), previousState = useRef(void 0), t3 = previousDocument ?? "", t4 = nextDocument ?? "", t5 = mode ?? "";
  let t6;
...
function usePathSyncChannel(t0) {
  ...
  if ($[3] !== id || $[4] !== syncChannel) {
    ...
    $[6] !== id ? (t32 = (t4) => {
      ...
      return source !== id;
    }, $[6] = id, $[7] = t32) : t32 = $[7], t2 = syncChannel.pipe(distinctUntilChanged(_temp$J), filter(t32), map(_temp2$i)), $[3] = id, $[4] = syncChannel, $[5] = t2;
  } else
    t2 = $[5];
  const path = t2;
  let t3;
...
function RequestPermissionDialog(t0) {
  ...
  bb0: {
    ...
    if ($[2] !== client.observable || $[3] !== projectId) {
      let t42;
      $[5] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t42 = (roles) => roles.filter(_temp$E).find(_temp2$g) ? "editor" : adminRole, $[5] = t42) : t42 = $[5];
      let t52;
...
function InsufficientPermissionBanner(t0) {
  ...
  const listFormat = useListFormat(t2), {
    t
  } = useTranslation(structureLocaleNamespace), telemetry = useTelemetry(), roleTitles = currentUserRoles.map(_temp$D), roles = listFormat.formatToParts(roleTitles).map(_temp2$f), showAskToEditAction = askToEditEnabled && isOnlyViewer && roleRequestStatus && !requestStatusError && !requestStatusLoading;
  let t3;
  $[5] !== roles ? (t3 = {
...
const FavoriteToggle = (t0) => {
  ...
  $[40] !== activeView.type || $[41] !== archivedScheduledDraftRelease || $[42] !== displayed || $[43] !== documentId || $[44] !== editState || $[45] !== filteredReleases || $[46] !== isPausedDraft || $[47] !== isPermissionsLoading || $[48] !== params?.historyVersion || $[49] !== permissions?.granted || $[50] !== ready || $[51] !== requiredPermission || $[52] !== schemaType || $[53] !== selectedPerspective || $[54] !== selectedPerspectiveName || $[55] !== selectedReleaseId || $[56] !== value._id || $[57] !== workspace ? (t12 = () => {
    ...
    const scheduledCardinalityOneRelease = [...filteredReleases.currentReleases, ...filteredReleases.notCurrentReleases].find(_temp$y), isPinnedDraftOrPublish = isSystemBundle(selectedPerspective), isCurrentVersionGoingToUnpublish = editState?.version && isGoingToUnpublish(editState?.version);
...
const DocumentGroupInventoryHint = () => {
  ...
  let t4;
  $[7] !== t3 ? (t4 = /* @__PURE__ */ jsx(Text, { size: 1, weight: "medium", children: /* @__PURE__ */ jsxs(Flex, { gap: 2, align: "center", justify: "flex-end", children: [
    t2,
    " ",
    t3
  ] }) }), $[7] = t3, $[8] = t4) : t4 = $[8];
  ...
  theme
}) => css`display:inline-block;vertical-align:middle;appearance:none;border:0;margin:0;padding:0;outline:none;all:unset;color:var(--card-badge-suggest-fg-color);cursor:pointer;*{color:inherit;}svg[data-sanity-icon]{color:currentColor;}`);
...
function useDocumentPerspectiveList() {
  ...
  const {
    data: documentVersions
  } = useDocumentVersions(t2), onlyHasVersions = documentVersions && documentVersions.length > 0 && !documentVersions.some(_temp$w), workspace = useWorkspace(), {
    onSetScheduledDraftPerspective
  } = useSingleDocRelease();
  let t3;
...
const HorizontalScroller = /* @__PURE__ */ styled(Card).withConfig({
  ...
  return $[20] !== BackLink2 || $[21] !== backButton || $[22] !== collapsed || $[23] !== connectionState || $[24] !== contextMenuNodes || $[25] !== documentLevelPresence || $[26] !== editState || $[27] !== handleFocusPane || $[28] !== hasDocumentGroupInventory || $[29] !== isMaximizedPane || $[30] !== menuButtonNodes || $[31] !== onPaneClose || $[32] !== onPaneSplit || $[33] !== onSetMaximizedPane || $[34] !== paneHeaderZIndex || $[35] !== ref || $[36] !== referenceElement || $[37] !== schemaType || $[38] !== showGradient || $[39] !== showPaneGroupCloseButton || $[40] !== showSplitPaneButton || $[41] !== showSplitPaneCloseButton || $[42] !== t || $[43] !== tabIndex || $[44] !== unstable_languageFilter ? (t7 = /* @__PURE__ */ jsx(TooltipDelayGroupProvider, { children: collapsed ? /* @__PURE__ */ jsx(PaneHeader$1, { border: !0, ref, loading: connectionState === "connecting" && !editState?.draft && !editState?.published, title, tabIndex, backButton }) : /* @__PURE__ */ jsx(Card, { hidden: collapsed, style: {
    ...
    hasDocumentGroupInventory && /* @__PURE__ */ jsx(Box, { paddingX: 3, children: /* @__PURE__ */ jsx(DocumentGroupInventoryHint, {}) }),
...
const DocumentPublished = defineEvent({
  ...
  const bundleId = t1, isAgentBundle = isAgentBundleName(bundleId), {
    delete: deleteOp
  } = useDocumentOperation(id, type, bundleId), [isDeleting, setIsDeleting] = useState(!1), [isConfirmDialogOpen, setConfirmDialogOpen] = useState(!1), documentStore = useDocumentStore(), telemetry = useTelemetry(), {
    t
  } = useTranslation(structureLocaleNamespace);
  let t2;
  $[2] !== id ? (t2 = {
  ...
  bb0: {
    ...
    if (!isPermissionsLoading && !permissions?.granted) {
      ...
      let t102;
      $[20] !== currentUser ? (t102 = /* @__PURE__ */ jsx(InsufficientPermissionsMessage, { context: "delete-document", currentUser }), $[20] = currentUser, $[21] = t102) : t102 = $[21];
      let t112;
      $[22] !== t102 || $[23] !== t92 ? (t112 = {
        tone: "critical",
        icon: TrashIcon,
...
const documentGroupInventoryComponents = {
  ...
  let t5;
  $[26] !== displayed || $[27] !== documentType || $[28] !== hasDocumentGroupInventory || $[29] !== isDocumentGroupInventoryActive || $[30] !== navigatePerspective || $[31] !== perspectiveList || $[32] !== referringDocuments$ || $[33] !== setIsDocumentGroupInventoryActive ? (t5 = hasDocumentGroupInventory && typeof displayed?._id < "u" && /* @__PURE__ */ jsx(DocumentGroupInventoryAction, { documentId: displayed._id, portalElementName: DOCUMENT_PANEL_PORTAL_ELEMENT, isDocumentGroupInventoryActive, setIsDocumentGroupInventoryActive, children: /* @__PURE__ */ jsx(DocumentGroupInventory, { documentId: displayed._id, documentType, portalElementName: DOCUMENT_PANEL_PORTAL_ELEMENT, navigatePerspective, perspectiveList, referringDocuments$, components: documentGroupInventoryComponents }) }), $[26] = displayed, $[27] = documentType, $[28] = hasDocumentGroupInventory, $[29] = isDocumentGroupInventoryActive, $[30] = navigatePerspective, $[31] = perspectiveList, $[32] = referringDocuments$, $[33] = setIsDocumentGroupInventoryActive, $[34] = t5) : t5 = $[34];
  let t6;
  $[35] !== disabled || $[36] !== firstActionState || $[37] !== showFirstActionButton || $[38] !== tooltipContent ? (t6 = showFirstActionButton && /* @__PURE__ */ jsx(LayerProvider, { zOffset: 200, children: /* @__PURE__ */ jsx(Tooltip, { disabled: !tooltipContent, content: tooltipContent, placement: "top", children: /* @__PURE__ */ jsx(Stack, { children: /* @__PURE__ */ jsx(Button$1, { "data-testid": `action-${toLowerCaseNoSpaces(firstActionState.label)}`, disabled: disabled || !!firstActionState.disabled, icon: firstActionState.icon, onClick: firstActionState.onHandle, ref: setButtonElement, text: firstActionState.label, tone: firstActionState.tone || "primary" }) }) }) }), $[35] = disabled, $[36] = firstActionState, $[37] = showFirstActionButton, $[38] = tooltipContent, $[39] = t6) : t6 = $[39];
  let t7;
  $[40] !== disabled || $[41] !== sideMenuItems ? (t7 = sideMenuItems.length > 0 && /* @__PURE__ */ jsx(ActionMenuButton, { actionStates: sideMenuItems, disabled }), $[40] = disabled, $[41] = sideMenuItems, $[42] = t7) : t7 = $[42];
  let t8;
  $[43] !== buttonElement || $[44] !== firstActionState || $[45] !== showFirstActionButton ? (t8 = showFirstActionButton && firstActionState && firstActionState.dialog && /* @__PURE__ */ jsx(ActionStateDialog, { dialog: firstActionState.dialog, referenceElement: buttonElement }), $[43] = buttonElement, $[44] = firstActionState, $[45] = showFirstActionButton, $[46] = t8) : t8 = $[46];
  let t9;
  return $[47] !== t4 || $[48] !== t5 || $[49] !== t6 || $[50] !== t7 || $[51] !== t8 ? (t9 = /* @__PURE__ */ jsxs(Flex, { align: "center", gap: 3, children: [
    t4,
    t5,
    t6,
    t7,
...
function DocumentPaneProvider(props) {
  ...
  const {
    ...
    inspectOpen,
    handleLegacyInspectClose
  } = useDocumentPaneInspector(t14), [isDeleting, setIsDeleting] = useState(!1), [isDocumentGroupInventoryActive, setIsDocumentGroupInventoryActive] = useState(!1), {
    lastRevisionDocument
  } = useDeletedDocumentLastRevision();
  let t15;
  ...
  let t22;
  $[42] !== changesOpen || $[43] !== documentId || $[44] !== documentType || $[45] !== getComparisonValue || $[46] !== getDisplayed || $[47] !== getIsReadOnly || $[48] !== initialValue || $[49] !== onFocusPath || $[50] !== onOlderRevision || $[51] !== selectedPerspectiveName || $[52] !== t20 || $[53] !== t21 ? (t22 = {
    changesOpen,
    documentType,
    documentId,
    initialValue,
  ...
  }, $[42] = changesOpen, $[43] = documentId, $[44] = documentType, $[45] = getComparisonValue, $[46] = getDisplayed, $[47] = getIsReadOnly, $[48] = initialValue, $[49] = onFocusPath, $[50] = onOlderRevision, $[51] = selectedPerspectiveName, $[52] = t20, $[53] = t21, $[54] = t22) : t22 = $[54];
  const {
  ...
  const actions = t25;
  let t26;
  $[70] !== onPathOpen || $[71] !== params || $[72] !== setPaneParams ? (t26 = (path) => {
    onPathOpen(path);
  ...
  }, $[70] = onPathOpen, $[71] = params, $[72] = setPaneParams, $[73] = t26) : t26 = $[73];
  const handlePathOpen = t26;
  let t27;
  $[74] !== documentBadges2 || $[75] !== documentId || $[76] !== documentType ? (t27 = documentBadges2({
    schemaType: documentType,
    documentId
  }), $[74] = documentBadges2, $[75] = documentId, $[76] = documentType, $[77] = t27) : t27 = $[77];
  const badges = t27;
  let t28;
  $[78] !== documentId || $[79] !== documentType || $[80] !== languageFilterResolver ? (t28 = languageFilterResolver({
    schemaType: documentType,
    documentId
  }), $[78] = documentId, $[79] = documentType, $[80] = languageFilterResolver, $[81] = t28) : t28 = $[81];
  ...
  let t29;
  $[82] !== documentId || $[83] !== documentType || $[84] !== fieldActionsResolver || $[85] !== schemaType ? (t29 = schemaType ? fieldActionsResolver({
    documentId,
    documentType,
    schemaType
  }) : [], $[82] = documentId, $[83] = documentType, $[84] = fieldActionsResolver, $[85] = schemaType, $[86] = t29) : t29 = $[86];
  const fieldActions = t29, ready = formReady && (!params.rev || timelineReady || !!timelineError), t30 = schemaType?.name, t31 = !!params.rev;
  let t32;
  $[87] !== editState_1 || $[88] !== ready || $[89] !== t30 || $[90] !== t31 ? (t32 = {
    ready,
    schemaTypeName: t30,
    editState: editState_1,
    hasRevisionParam: t31
  }, $[87] = editState_1, $[88] = ready, $[89] = t30, $[90] = t31, $[91] = t32) : t32 = $[91], useDocumentInitialLoadTelemetry(t32);
  let t33;
  $[92] !== getDisplayed || $[93] !== value_0 ? (t33 = getDisplayed(value_0), $[92] = getDisplayed, $[93] = value_0, $[94] = t33) : t33 = $[94];
  const displayed = t33;
  let t34;
  $[95] !== displayed || $[96] !== documentId || $[97] !== editState_1 ? (t34 = {
    strict: !0,
    displayed,
    documentId,
    editState: editState_1
  }, $[95] = displayed, $[96] = documentId, $[97] = editState_1, $[98] = t34) : t34 = $[98];
  const {
    previousId
  } = useDocumentIdStack(t34);
  let t35;
  $[99] !== params || $[100] !== setPaneParams ? (t35 = (newSince, newRev) => {
    setPaneParams({
      ...params,
      since: newSince,
      rev: newRev || void 0
    });
  }, $[99] = params, $[100] = setPaneParams, $[101] = t35) : t35 = $[101];
  const setTimelineRange = t35;
  let t36;
  $[102] !== paneRouter ? (t36 = () => paneRouter.closeCurrent(), $[102] = paneRouter, $[103] = t36) : t36 = $[103];
  const handlePaneClose = t36;
  let t37;
  $[104] !== paneRouter ? (t37 = () => paneRouter.duplicateCurrent(), $[104] = paneRouter, $[105] = t37) : t37 = $[105];
  const handlePaneSplit = t37;
  let t38;
  $[106] !== router2 || $[107] !== telemetry ? (t38 = () => {
  ...
  }), !0) : item.action === "toggleInlineChanges" ? (toggleInlineChanges(), !0) : !1), $[109] = diffViewRouter, $[110] = documentType, $[111] = handleHistoryOpen, $[112] = handleInspectorAction, $[113] = previewUrl, $[114] = previousId, $[115] = toggleInlineChanges, $[116] = value_0._id, $[117] = t39) : t39 = $[117];
  const handleMenuAction = t39;
  let t40, t41;
  $[118] !== documentId || $[119] !== documentType || $[120] !== onChange || $[121] !== schemaType || $[122] !== setDocumentMeta ? (t40 = () => {
    setDocumentMeta({
      documentId,
      documentType,
      schemaType,
  ...
  }, t41 = [documentId, documentType, schemaType, onChange, setDocumentMeta], $[118] = documentId, $[119] = documentType, $[120] = onChange, $[121] = schemaType, $[122] = setDocumentMeta, $[123] = t40, $[124] = t41) : (t40 = $[123], t41 = $[124]), useEffect(t40, t41);
  let t42;
  $[125] !== getComparisonValue || $[126] !== upstreamEditState_0 ? (t42 = getComparisonValue(upstreamEditState_0), $[125] = getComparisonValue, $[126] = upstreamEditState_0, $[127] = t42) : t42 = $[127];
  ...
  $[130] !== actions || $[131] !== activeViewId || $[132] !== badges || $[133] !== changesOpen || $[134] !== closeInspector || $[135] !== collapsedFieldSets || $[136] !== collapsedPaths || $[137] !== compareValue || $[138] !== connectionState || $[139] !== currentDisplayed || $[140] !== documentId || $[141] !== documentIdRaw || $[142] !== documentType || $[143] !== editState_1 || $[144] !== fieldActions || $[145] !== focusPath || $[146] !== formState || $[147] !== handleHistoryClose || $[148] !== handleHistoryOpen || $[149] !== handleLegacyInspectClose || $[150] !== handleMenuAction || $[151] !== handlePaneClose || $[152] !== handlePaneSplit || $[153] !== handlePathOpen || $[154] !== hasUpstreamVersion || $[155] !== index || $[156] !== inspectOpen || $[157] !== inspectors2 || $[158] !== isDeleted_1 || $[159] !== isDeleting || $[160] !== isDocumentGroupInventoryActive || $[161] !== isInitialValueLoading || $[162] !== isPermissionsLoading || $[163] !== languageFilter || $[164] !== lastNonDeletedRevId || $[165] !== lastRevisionDocument || $[166] !== maximized || $[167] !== onBlur || $[168] !== onChange || $[169] !== onFocus || $[170] !== onSetActiveFieldGroup || $[171] !== onSetCollapsedFieldSet || $[172] !== onSetCollapsedPath || $[173] !== onSetMaximizedPane || $[174] !== openInspector || $[175] !== openPath || $[176] !== paneKey || $[177] !== permissions || $[178] !== previewUrl || $[179] !== ready || $[180] !== revisionId || $[181] !== revisionNotFound || $[182] !== schemaType || $[183] !== selectedReleaseId || $[184] !== setTimelineRange || $[185] !== t44 || $[186] !== t45 || $[187] !== timelineError || $[188] !== timelineStore || $[189] !== title || $[190] !== validation || $[191] !== value_0 || $[192] !== views ? (t46 = {
    ...
    lastNonDeletedRevId,
    lastRevisionDocument
  }, $[130] = actions, $[131] = activeViewId, $[132] = badges, $[133] = changesOpen, $[134] = closeInspector, $[135] = collapsedFieldSets, $[136] = collapsedPaths, $[137] = compareValue, $[138] = connectionState, $[139] = currentDisplayed, $[140] = documentId, $[141] = documentIdRaw, $[142] = documentType, $[143] = editState_1, $[144] = fieldActions, $[145] = focusPath, $[146] = formState, $[147] = handleHistoryClose, $[148] = handleHistoryOpen, $[149] = handleLegacyInspectClose, $[150] = handleMenuAction, $[151] = handlePaneClose, $[152] = handlePaneSplit, $[153] = handlePathOpen, $[154] = hasUpstreamVersion, $[155] = index, $[156] = inspectOpen, $[157] = inspectors2, $[158] = isDeleted_1, $[159] = isDeleting, $[160] = isDocumentGroupInventoryActive, $[161] = isInitialValueLoading, $[162] = isPermissionsLoading, $[163] = languageFilter, $[164] = lastNonDeletedRevId, $[165] = lastRevisionDocument, $[166] = maximized, $[167] = onBlur, $[168] = onChange, $[169] = onFocus, $[170] = onSetActiveFieldGroup, $[171] = onSetCollapsedFieldSet, $[172] = onSetCollapsedPath, $[173] = onSetMaximizedPane, $[174] = openInspector, $[175] = openPath, $[176] = paneKey, $[177] = permissions, $[178] = previewUrl, $[179] = ready, $[180] = revisionId, $[181] = revisionNotFound, $[182] = schemaType, $[183] = selectedReleaseId, $[184] = setTimelineRange, $[185] = t44, $[186] = t45, $[187] = timelineError, $[188] = timelineStore, $[189] = title, $[190] = validation, $[191] = value_0, $[192] = views, $[193] = t46) : t46 = $[193];
  const documentPane = t46;
  let t47;
  $[194] !== menuItemGroups ? (t47 = menuItemGroups || [], $[194] = menuItemGroups, $[195] = t47) : t47 = $[195];
  let t48;
  $[196] !== actions || $[197] !== badges || $[198] !== documentId || $[199] !== documentIdRaw || $[200] !== documentType || $[201] !== fieldActions || $[202] !== handlePaneClose || $[203] !== handlePaneSplit || $[204] !== index || $[205] !== languageFilter || $[206] !== maximized || $[207] !== onSetMaximizedPane || $[208] !== paneKey || $[209] !== schemaType || $[210] !== t47 || $[211] !== title || $[212] !== views ? (t48 = {
    actions,
    badges,
    documentId,
    documentIdRaw,
    ...
    views,
    unstable_languageFilter: languageFilter
  }, $[196] = actions, $[197] = badges, $[198] = documentId, $[199] = documentIdRaw, $[200] = documentType, $[201] = fieldActions, $[202] = handlePaneClose, $[203] = handlePaneSplit, $[204] = index, $[205] = languageFilter, $[206] = maximized, $[207] = onSetMaximizedPane, $[208] = paneKey, $[209] = schemaType, $[210] = t47, $[211] = title, $[212] = views, $[213] = t48) : t48 = $[213];
  const documentPaneInfo = t48, pathRef = useRef(void 0), paramPath = params.path;
  let t49;
  $[214] !== formStateRef || $[215] !== onProgrammaticFocus || $[216] !== openPath ? (t49 = (urlPath) => {
  ...
  }, $[214] = formStateRef, $[215] = onProgrammaticFocus, $[216] = openPath, $[217] = t49) : t49 = $[217];
  const syncPathFromUrl = useEffectEvent(t49);
  let t50;
  $[218] !== paramPath || $[219] !== ready || $[220] !== syncPathFromUrl ? (t50 = () => {
    ready && paramPath && syncPathFromUrl(paramPath), pathRef.current = paramPath;
  }, $[218] = paramPath, $[219] = ready, $[220] = syncPathFromUrl, $[221] = t50) : t50 = $[221];
  let t51;
  $[222] !== paramPath || $[223] !== ready ? (t51 = [paramPath, ready], $[222] = paramPath, $[223] = ready, $[224] = t51) : t51 = $[224], useEffect(t50, t51);
  const isDivergencesEnabled = advancedVersionControlEnabled && !!(formState && schemaType);
  let t52;
  $[225] !== editState_1 || $[226] !== formState || $[227] !== isDivergencesEnabled || $[228] !== schemaType || $[229] !== upstreamEditState_0 || $[230] !== value_0._id ? (t52 = isDivergencesEnabled && formState && schemaType ? {
    enabled: !0,
    upstreamEditState: upstreamEditState_0,
    editState: editState_1,
    ...
    enabled: !1
  }, $[225] = editState_1, $[226] = formState, $[227] = isDivergencesEnabled, $[228] = schemaType, $[229] = upstreamEditState_0, $[230] = value_0._id, $[231] = t52) : t52 = $[231];
  const divergencesProps = t52;
  let t53;
  $[232] !== onProgrammaticFocus ? (t53 = /* @__PURE__ */ jsx(DivergenceAutofocus, { onProgrammaticFocus }), $[232] = onProgrammaticFocus, $[233] = t53) : t53 = $[233];
  let t54;
  $[234] !== displayed || $[235] !== isDeleted_1 || $[236] !== ready || $[237] !== schemaType ? (t54 = /* @__PURE__ */ jsx(DocumentTitle, { isDeleted: isDeleted_1, displayed, ready, schemaType }), $[234] = displayed, $[235] = isDeleted_1, $[236] = ready, $[237] = schemaType, $[238] = t54) : t54 = $[238];
  let t55;
  $[239] !== children ? (t55 = /* @__PURE__ */ jsx(ParseErrorsProvider, { children }), $[239] = children, $[240] = t55) : t55 = $[240];
  let t56;
  $[241] !== divergencesProps || $[242] !== t53 || $[243] !== t54 || $[244] !== t55 ? (t56 = /* @__PURE__ */ jsxs(DivergencesProvider, { ...divergencesProps, children: [
    t53,
    t54,
    t55
  ] }), $[241] = divergencesProps, $[242] = t53, $[243] = t54, $[244] = t55, $[245] = t56) : t56 = $[245];
  let t57;
  $[246] !== documentPane || $[247] !== t56 ? (t57 = /* @__PURE__ */ jsx(DocumentPaneContext.Provider, { value: documentPane, children: t56 }), $[246] = documentPane, $[247] = t56, $[248] = t57) : t57 = $[248];
  let t58;
  return $[249] !== documentPaneInfo || $[250] !== t57 ? (t58 = /* @__PURE__ */ jsx(DocumentPaneInfoContext.Provider, { value: documentPaneInfo, children: t57 }), $[249] = documentPaneInfo, $[250] = t57, $[251] = t58) : t58 = $[251], t58;
}
