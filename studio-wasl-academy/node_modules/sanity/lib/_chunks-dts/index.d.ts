...
declare const structureLocaleStrings: {
  ...
  'doc-title.unknown-schema-type.text': string; /** Hint shown to help guide users to the new document group inventory */
  'document-group-inventory.onboarding-hint': string; /** Tooltip text shown for the close button of the document inspector */
