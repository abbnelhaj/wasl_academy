...
import { $p as require_speakingurl, Au as useCommentsSelectedPath, Cy as require_react_is, Du as useComments, Fa as buildTextSelectionFromFragment, Hh as debounce, Jb as require_compiler_runtime, Kp as require_client, Ma as buildCommentRangeDecorations, Ou as useCommentsEnabled, Pa as buildRangeDecorationSelectionsFromComments, Qs as hasCommentMessageValue, Sy as gt, Um as Button, Wp as require_semver, X as CommentInlineHighlightSpan, Xp as require_exif_component, Y as CommentDisabledIcon, Ym as Popover, Z as CommentInput, Zc as isTextSelectionComment, am as require_reduce, ap as useTranslation, cm as require_json_stable_stringify, d_ as require_react_fast_compare, dm as require_ttlcache, du as useAddonDataset, dy as useClickOutsideEvent, fm as require_dataloader, h_ as toString, hy as usePortal, jm as PortableTextEditor, ku as useCommentsScroll, nv as isPortableTextTextBlock, oh as require_with_selector, qp as require_server_browser, rm as require_raf, ry as Stack, sh as v4, sm as require_shallow_equals, vy as motion, wv as BoundaryElementProvider, wy as AddCommentIcon, x_ as isArrayOfBlocksSchemaType, xh as isEqual, yd as useFieldActions, yy as AnimatePresence, za as commentsLocaleNamespace, zu as useCurrentUser } from "./lib-CAxWiL3Y.js";
...
var MotionPopover = gt(motion.create(Popover)).withConfig({
...
var POPOVER_FALLBACK_PLACEMENTS = ["bottom", "top"], RootStack = gt(Stack).withConfig({
...
var EMPTY_ARRAY = [], AI_ASSIST_TYPE = "sanity.assist.instruction.prompt";
...
var CommentsPortableTextInputInner = (0, import_react.memo)(function(props) {
	...
	const handleDecoratorClick = t8, blurred = (0, import_react.useRef)(!1);
	let t9;
	...
	$[35] !== addedCommentsDecorations || $[36] !== getComment || $[37] !== operation ? (t13 = () => {
		...
		decoratorsToUpdate.length !== 0 && (decoratorsToUpdate.forEach((decorator_0) => {
			...
			if (!comment_1 || !editorRef.current) return;
			const editorValue_0 = PortableTextEditor.getValue(editorRef.current) || EMPTY_ARRAY, [updatedDecoration] = buildRangeDecorationSelectionsFromComments({
				comments: [comment_1],
				value: editorValue_0
			}), nextRange = updatedDecoration?.range ? [updatedDecoration.range] : EMPTY_ARRAY, nextValue_0 = updatedDecoration ? [...comment_1.target.path?.selection?.value.filter((r) => r._key !== nextRange[0]?._key).concat(nextRange).flat().sort(_temp4) || EMPTY_ARRAY] : EMPTY_ARRAY, nextComment = { target: {
				...comment_1.target,
				path: {
	...
	let t18;
	$[49] !== addedCommentsDecorations || $[50] !== authoringDecoration || $[51] !== t17 ? (t18 = [
		...t17,
		...authoringDecoration ? [authoringDecoration] : EMPTY_ARRAY,
		...addedCommentsDecorations
	], $[49] = addedCommentsDecorations, $[50] = authoringDecoration, $[51] = t17, $[52] = t18) : t18 = $[52];
	const rangeDecorations = t18, [currentSelectionIsOverlapping, setCurrentSelectionIsOverlapping] = (0, import_react.useState)(!1);
	let t19, t20;
	...
	}, t20 = [addedCommentsDecorations, currentSelection], $[53] = addedCommentsDecorations, $[54] = currentSelection, $[55] = t19, $[56] = t20) : (t19 = $[55], t20 = $[56]), (0, import_react.useEffect)(t19, t20);
	...
	bb1: {
		...
		let t242;
		$[60] !== currentSelectionRect ? (t242 = { getBoundingClientRect: () => currentSelectionRect }, $[60] = currentSelectionRect, $[61] = t242) : t242 = $[61], t23 = t242;
	}
	...
	], $[62] = currentSelection, $[63] = scrollElement, $[64] = t24, $[65] = t25) : (t24 = $[64], t25 = $[65]), (0, import_react.useEffect)(t24, t25);
	let t26, t27;
	...
	}, t27 = [handleBuildRangeDecorations, textComments], $[66] = handleBuildRangeDecorations, $[67] = textComments, $[68] = t26, $[69] = t27) : (t26 = $[68], t27 = $[69]), (0, import_react.useEffect)(t26, t27);
	...
	let t28;
	$[70] !== currentUser || $[71] !== handleSubmit || $[72] !== mentionOptions || $[73] !== nextCommentValue || $[74] !== popoverAuthoringReferenceElement || $[75] !== showFloatingInput ? (t28 = showFloatingInput && currentUser && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(InlineCommentInputPopover, {
		currentUser,
		mentionOptions,
	...
	}), $[70] = currentUser, $[71] = handleSubmit, $[72] = mentionOptions, $[73] = nextCommentValue, $[74] = popoverAuthoringReferenceElement, $[75] = showFloatingInput, $[76] = t28) : t28 = $[76];
	let t29;
	$[77] !== addonDatasetError || $[78] !== currentSelectionIsOverlapping || $[79] !== handleSelectCurrentSelection || $[80] !== selectionReferenceElement || $[81] !== showFloatingButton || $[82] !== showFloatingInput ? (t29 = showFloatingButton && !showFloatingInput && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FloatingButtonPopover, {
	...
	}), $[77] = addonDatasetError, $[78] = currentSelectionIsOverlapping, $[79] = handleSelectCurrentSelection, $[80] = selectionReferenceElement, $[81] = showFloatingButton, $[82] = showFloatingInput, $[83] = t29) : t29 = $[83];
	let t30;
	$[84] !== t29 ? (t30 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AnimatePresence, { children: t29 }), $[84] = t29, $[85] = t30) : t30 = $[85];
	let t31;
	$[86] !== boundaryElement || $[87] !== t28 || $[88] !== t30 ? (t31 = /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(BoundaryElementProvider, {
		element: boundaryElement,
		children: [t28, t30]
	}), $[86] = boundaryElement, $[87] = t28, $[88] = t30, $[89] = t31) : t31 = $[89];
	let t32;
	$[90] !== onEditorChange || $[91] !== props || $[92] !== rangeDecorations ? (t32 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Stack, {
		ref: setRootElement,
	...
	}), $[90] = onEditorChange, $[91] = props, $[92] = rangeDecorations, $[93] = t32) : t32 = $[93];
	let t33;
	return $[94] !== t31 || $[95] !== t32 ? (t33 = /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [t31, t32] }), $[94] = t31, $[95] = t32, $[96] = t33) : t33 = $[96], t33;
});
